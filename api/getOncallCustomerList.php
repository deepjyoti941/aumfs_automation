...
require_once 'config/config.php';
	...
	$query="SELECT oc.bill_number, oc.billing_price, oc.oncall_service_id, oc.service_name, oc.order_date_time, oc.customer_feedback, ed.employee_name, ed.is_engaged,cd.customer_address,cd.customer_phone,cd.black_listed,cd.customer_name
