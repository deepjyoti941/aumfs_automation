...
require_once 'config/config.php';
	...
	$query="SELECT oc.oncall_service_id, oc.service_name, oc.order_date_time, ed.employee_name, ed.is_engaged,cd.customer_address,cd.customer_phone,cd.customer_name
