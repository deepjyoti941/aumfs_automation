...
angular.module("app.controllers", [])
	...
	.controller("AppCtrl", ["$scope", "$location", "DreamFactory", "logger", function ($scope, $location, DreamFactory, logger) {
		...
		}, $scope.main = {brand: "AUMFS Automation", name: "Admin Name", image: me}
	}])
